    ...
    async fn set_irq_params(&mut self, radio_mode: Option<RadioMode>) -> Result<(), RadioError> {
        match radio_mode {
            ...
            Some(RadioMode::Receive(_)) => {
                ...
                let val = (dio_mapping_1 & DioMapping1Dio0::Mask.value() & DioMapping1Dio1::Mask.value() & DioMapping1Dio3::Mask.value())
                    | (DioMapping1Dio0::RxDone.value() | DioMapping1Dio1::RxTimeOut.value() | DioMapping1Dio3::ValidHeader.value());
